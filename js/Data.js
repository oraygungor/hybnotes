...
window.HybNotesData = {
        ...
        
  {
    ...
    "summary": {
      "tr": "Prof. Andrew M. Jones, dayanıklılık performansını belirleyen klasik üçlü modele ($\\dot{V}_{O_{2}max}$, Ekonomi, Eşik) karşı çıkarak, bu değerlerin yorgunlukla bozulabileceğini vurguluyor ve denkleme \"Fizyolojik Direnç\" (Resilience) adında dördüncü bir boyut ekliyor. Bu yeni değişken, sporcunun başlangıçtaki kapasitesinden bağımsız olarak, yarışın sonlarında performans düşüşüne (Kritik Güç/Hız kaybına) ne kadar direnebildiğini temsil ediyor ve şampiyonları belirleyen asıl faktörün bu \"bozulmama yeteneği\" olduğunu savunuyor.",
      "en": "Prof. Andrew M. Jones challenges the classic tripartite model determining endurance performance ($\\dot{V}_{O_{2}max}$, Economy, Threshold), emphasizing that these values deteriorate with fatigue, and adds a fourth dimension called \"Physiological Resilience\" to the equation. This new variable represents how well an athlete can resist performance decline (loss of Critical Power/Speed) late in a race, independent of their initial capacity, arguing that this \"ability not to break\" is the true factor that determines champions."
    },
    "content": {
      "tr": "<p><span style='background-color: rgba(0, 0, 0, 0);'>Bir maratoncunun potansiyelini tahmin etmek için elimizde yıllardır güvenilen, 3 temel değişkene dayalı 'Klasik Model' vardı. Ancak bilim insanları, bu modelin kağıt üzerindeki tahminlerinin, yorgunluk faktörü devreye girdiğinde gerçek yarış sonuçlarıyla her zaman örtüşmediğini fark etti.</span></p><p><span style='background-color: rgba(0, 0, 0, 0);'>Prof. Andrew M. Jones’un ses getiren makalesi, 30 yıllık bu kavramsal çerçeveyi güncelliyor ve modele </span><strong style='background-color: rgba(0, 0, 0, 0);'>'Fizyolojik Direnç' (Resilience)</strong><span style='background-color: rgba(0, 0, 0, 0);'> adında, bağımsız bir aday değişken eklenmesini öneriyor.</span></p><p>İşte Jones'un önerdiği güncel modelin detayları ve bilimsel arka planı:</p><h2>Klasik Model (1991): Performansın 3 Ayağı</h2><p><span style='background-color: rgba(0, 0, 0, 0);'>Hikaye, Dr. Michael Joyner'ın 1991 yılında yayınladığı ve bugün hala referans alınan modelle başlıyor. Joyner, dayanıklılık performansını şu 3 fizyolojik sütun üzerine kurmuştu:</span></p><p><span style='background-color: rgba(0, 0, 0, 0);'>+2</span></p><ol><li><strong style='background-color: rgba(0, 0, 0, 0);'>Motorun Hacmi ($\\dot{V}_{O_{2}max}$):</strong> Sporcunun maksimal oksijen kapasitesi.</li><li><strong style='background-color: rgba(0, 0, 0, 0);'>Yakıt Verimliliği (Koşu Ekonomisi):</strong> Belirli bir hızda harcanan enerji miktarı.</li><li><strong style='background-color: rgba(0, 0, 0, 0);'>Sürdürülebilir Eşik (Laktat Eşiği/Kritik Hız):</strong> Motoru boğmadan çıkılabilen maksimum devir.</li></ol><p><span style='background-color: rgba(0, 0, 0, 0);'>Ancak bu model, değişkenleri büyük ölçüde </span><strong style='background-color: rgba(0, 0, 0, 0);'>statik</strong><span style='background-color: rgba(0, 0, 0, 0);'> kabul ediyordu; yani start çizgisindeki fizyolojik değerlerin yarış boyunca sabit kaldığı varsayılıyordu.</span></p><h2>Eksik Parça: 'Yorgunlukla Aşınma'</h2><p><span style='background-color: rgba(0, 0, 0, 0);'>Andrew Jones, bu değişkenlerin sabit olmadığını ve yorgunlukla birlikte bozulduğunu vurguluyor.</span></p><ul><li><strong style='background-color: rgba(0, 0, 0, 0);'>Kritik Güç Kaybı:</strong><span style='background-color: rgba(0, 0, 0, 0);'> Bisikletçiler üzerinde yapılan kontrollü çalışmalarda, 2 saatlik ağır bir egzersizden sonra sporcuların </span><strong style='background-color: rgba(0, 0, 0, 0);'>Kritik Güç (CP)</strong><span style='background-color: rgba(0, 0, 0, 0);'> değerlerinde ortalama </span><strong style='background-color: rgba(0, 0, 0, 0);'>~%10</strong><span style='background-color: rgba(0, 0, 0, 0);'> oranında bir düşüş saptanmıştır.</span></li><li><strong style='background-color: rgba(0, 0, 0, 0);'>Koşuya Yansıması:</strong><span style='background-color: rgba(0, 0, 0, 0);'> Jones, benzer bir mekanizmanın koşuda da geçerli olduğunu savunarak; yarış ilerledikçe koşu ekonomisinin ve kritik hızın (CS) bozulabileceğini, ancak klasik testlerin (sporcu dinlenikken yapıldığı için) bu kaybı göremediğini belirtmektedir.</span></li></ul><h2>Yeni Aday Değişken: 'Fizyolojik Direnç'</h2><p><span style='background-color: rgba(0, 0, 0, 0);'>Jones, performans modeline </span><strong style='background-color: rgba(0, 0, 0, 0);'>'Direnç'</strong><span style='background-color: rgba(0, 0, 0, 0);'> (Resilience) kavramının eklenmesini öneriyor. Bu, fizyolojik parametrelerin zamanla bozulmasına karşı koyabilme kapasitesidir.</span></p><ul><li><strong style='background-color: rgba(0, 0, 0, 0);'>Neden Önemli?</strong><span style='background-color: rgba(0, 0, 0, 0);'> Araştırmalarda, yorgunluk sonrası performans parametrelerindeki düşüşün bireyler arasında </span><strong style='background-color: rgba(0, 0, 0, 0);'>%1</strong><span style='background-color: rgba(0, 0, 0, 0);'> ile </span><strong style='background-color: rgba(0, 0, 0, 0);'>%32</strong><span style='background-color: rgba(0, 0, 0, 0);'> gibi çok geniş bir aralıkta değiştiği görülmüştür.</span></li><li><strong style='background-color: rgba(0, 0, 0, 0);'>Bağımsızlık İddiası:</strong><span style='background-color: rgba(0, 0, 0, 0);'> Mevcut verilerde, yorgunlukla ortaya çıkan bu performans düşüşünün büyüklüğü, sporcunun başlangıçtaki $\\dot{V}_{O_{2}max}$ veya Eşik değerleriyle zayıf ilişkili görünmektedir. Yani iki sporcunun başlangıç değerleri aynı olsa bile, biri 'dayanıklılık kaybına' daha dirençli olduğu için yarışı kazanabilir.</span></li></ul><h2>Direnci Destekleyen Faktörler</h2><p>Makale, bu direnç kapasitesini korumak için bazı kritik stratejilere işaret ediyor:</p><ul><li><strong style='background-color: rgba(0, 0, 0, 0);'>Yakıt Stratejisi:</strong><span style='background-color: rgba(0, 0, 0, 0);'> Çalışmalar, egzersiz sırasında saatte </span><strong style='background-color: rgba(0, 0, 0, 0);'>60g karbonhidrat</strong><span style='background-color: rgba(0, 0, 0, 0);'> alımının Kritik Güç (CP) düşüşünü, plaseboya kıyasla önemli ölçüde hafiflettiğini </span><strong style='background-color: rgba(0, 0, 0, 0);'>göstermiştir.</strong><span style='background-color: rgba(0, 0, 0, 0);'> (Not: Güncel literatürde bazı durumlarda bu miktar 90-120g/saat seviyelerine kadar çıkabilmektedir).</span></li><li><strong style='background-color: rgba(0, 0, 0, 0);'>Antrenman Geçmişi:</strong><span style='background-color: rgba(0, 0, 0, 0);'> Profesyonel bisikletçilerin, gençlere (U23) kıyasla yorgunluk altında güçlerini çok daha iyi korudukları gözlemlenmiştir; bu da direncin uzun yıllara dayanan antrenman birikimiyle geliştiğini düşündürmektedir.</span></li><li><strong style='background-color: rgba(0, 0, 0, 0);'>Ekipman:</strong><span style='background-color: rgba(0, 0, 0, 0);'> Yeni nesil ayakkabılar, kas hasarını azaltarak yorgunluğa bağlı ekonomi kaybını </span><strong style='background-color: rgba(0, 0, 0, 0);'>muhtemelen</strong><span style='background-color: rgba(0, 0, 0, 0);'> hafifletebilir.</span></li></ul><h2>Sonuç: Model Güncelleniyor</h2><p><span style='background-color: rgba(0, 0, 0, 0);'>Eskiden performans tahmini; büyük ölçüde </span><strong style='background-color: rgba(0, 0, 0, 0);'>Kapasite</strong><span style='background-color: rgba(0, 0, 0, 0);'> (VO2max) ve </span><strong style='background-color: rgba(0, 0, 0, 0);'>Verim</strong><span style='background-color: rgba(0, 0, 0, 0);'> (Ekonomi) üzerine kuruluydu.</span></p><p><span style='background-color: rgba(0, 0, 0, 0);'>Bugün Andrew Jones'un önerdiği genişletilmiş çerçeve, finişe geliş süresini belirleyen etkenin sadece 'taze' haldeki değerler değil, bu değerlerin </span><strong style='background-color: rgba(0, 0, 0, 0);'>yorgunluk altında ne kadar korunduğu</strong><span style='background-color: rgba(0, 0, 0, 0);'> (Direnç) olduğunu savunuyor. Elit atletler, fizyolojik parametreleri yarışın sonuna kadar 'sağlam kaldığı' için fark yaratıyor olabilir.</span></p>",
      "en": "<p><span style='background-color: rgba(0, 0, 0, 0);'>For years, we have had the trusted 'Classical Model' based on 3 fundamental variables to predict a marathoner's potential. However, scientists realized that this model's on-paper predictions did not always match real race results once the fatigue factor kicked in.</span></p><p><span style='background-color: rgba(0, 0, 0, 0);'>Prof. Andrew M. Jones’s influential paper updates this 30-year-old conceptual framework and proposes adding an independent candidate variable called </span><strong style='background-color: rgba(0, 0, 0, 0);'>'Physiological Resilience'</strong><span style='background-color: rgba(0, 0, 0, 0);'> to the model.</span></p><p>Here are the details and scientific background of the updated model proposed by Jones:</p><h2>The Classical Model (1991): The 3 Pillars of Performance</h2><p><span style='background-color: rgba(0, 0, 0, 0);'>The story begins with the model published by Dr. Michael Joyner in 1991, which is still referenced today. Joyner built endurance performance on these 3 physiological pillars:</span></p><p><span style='background-color: rgba(0, 0, 0, 0);'>+2</span></p><ol><li><strong style='background-color: rgba(0, 0, 0, 0);'>Engine Volume ($\\dot{V}_{O_{2}max}$):</strong> The athlete's maximal oxygen capacity.</li><li><strong style='background-color: rgba(0, 0, 0, 0);'>Fuel Efficiency (Running Economy):</strong> The amount of energy expended at a specific speed.</li><li><strong style='background-color: rgba(0, 0, 0, 0);'>Sustainable Threshold (Lactate Threshold/Critical Speed):</strong> The maximum RPM achievable without choking the engine.</li></ol><p><span style='background-color: rgba(0, 0, 0, 0);'>However, this model largely accepted these variables as </span><strong style='background-color: rgba(0, 0, 0, 0);'>static</strong><span style='background-color: rgba(0, 0, 0, 0);'>; meaning it was assumed that the physiological values at the starting line remained constant throughout the race.</span></p><h2>The Missing Piece: 'Decay with Fatigue'</h2><p><span style='background-color: rgba(0, 0, 0, 0);'>Andrew Jones emphasizes that these variables are not static and deteriorate with fatigue.</span></p><ul><li><strong style='background-color: rgba(0, 0, 0, 0);'>Critical Power Loss:</strong><span style='background-color: rgba(0, 0, 0, 0);'> In controlled studies on cyclists, an average decline of </span><strong style='background-color: rgba(0, 0, 0, 0);'>~10%</strong><span style='background-color: rgba(0, 0, 0, 0);'> in </span><strong style='background-color: rgba(0, 0, 0, 0);'>Critical Power (CP)</strong><span style='background-color: rgba(0, 0, 0, 0);'> values was detected after 2 hours of heavy exercise.</span></li><li><strong style='background-color: rgba(0, 0, 0, 0);'>Reflection in Running:</strong><span style='background-color: rgba(0, 0, 0, 0);'> Jones argues that a similar mechanism applies to running; as the race progresses, running economy and critical speed (CS) can deteriorate, but classical tests (performed while the athlete is rested) cannot see this loss.</span></li></ul><h2>The New Candidate Variable: 'Physiological Resilience'</h2><p><span style='background-color: rgba(0, 0, 0, 0);'>Jones proposes adding the concept of </span><strong style='background-color: rgba(0, 0, 0, 0);'>'Resilience'</strong><span style='background-color: rgba(0, 0, 0, 0);'> to the performance model. This is the capacity to withstand the deterioration of physiological parameters over time.</span></p><ul><li><strong style='background-color: rgba(0, 0, 0, 0);'>Why is it Important?</strong><span style='background-color: rgba(0, 0, 0, 0);'> Studies have shown that the decline in performance parameters after fatigue varies across a very wide range, between </span><strong style='background-color: rgba(0, 0, 0, 0);'>1%</strong><span style='background-color: rgba(0, 0, 0, 0);'> and </span><strong style='background-color: rgba(0, 0, 0, 0);'>32%</strong><span style='background-color: rgba(0, 0, 0, 0);'> among individuals.</span></li><li><strong style='background-color: rgba(0, 0, 0, 0);'>The Independence Claim:</strong><span style='background-color: rgba(0, 0, 0, 0);'> In current data, the magnitude of this performance drop that emerges with fatigue appears weakly related to the athlete's initial $\\dot{V}_{O_{2}max}$ or Threshold values. In other words, even if two athletes have the same starting values, the one who is more 'resilient' to endurance loss can win the race.</span></li></ul><h2>Factors Supporting Resilience</h2><p>The paper points to some critical strategies to maintain this resilience capacity:</p><ul><li><strong style='background-color: rgba(0, 0, 0, 0);'>Fuel Strategy:</strong><span style='background-color: rgba(0, 0, 0, 0);'> Studies have </span><strong style='background-color: rgba(0, 0, 0, 0);'>shown</strong><span style='background-color: rgba(0, 0, 0, 0);'> that consuming </span><strong style='background-color: rgba(0, 0, 0, 0);'>60g of carbohydrates</strong><span style='background-color: rgba(0, 0, 0, 0);'> per hour during exercise significantly mitigates the drop in Critical Power (CP) compared to a placebo. (Note: In current literature, this amount can go up to 90-120g/hour in some cases).</span></li><li><strong style='background-color: rgba(0, 0, 0, 0);'>Training History:</strong><span style='background-color: rgba(0, 0, 0, 0);'> It has been observed that professional cyclists maintain their power under fatigue much better than juniors (U23); this suggests that resilience develops with years of accumulated training.</span></li><li><strong style='background-color: rgba(0, 0, 0, 0);'>Equipment:</strong><span style='background-color: rgba(0, 0, 0, 0);'> New generation shoes may </span><strong style='background-color: rgba(0, 0, 0, 0);'>possibly</strong><span style='background-color: rgba(0, 0, 0, 0);'> mitigate economy loss due to fatigue by reducing muscle damage.</span></li></ul><h2>Conclusion: The Model is Updating</h2><p><span style='background-color: rgba(0, 0, 0, 0);'>In the past, performance prediction was largely based on </span><strong style='background-color: rgba(0, 0, 0, 0);'>Capacity</strong><span style='background-color: rgba(0, 0, 0, 0);'> (VO2max) and </span><strong style='background-color: rgba(0, 0, 0, 0);'>Efficiency</strong><span style='background-color: rgba(0, 0, 0, 0);'> (Economy).</span></p><p><span style='background-color: rgba(0, 0, 0, 0);'>Today, the extended framework proposed by Andrew Jones argues that the factor determining the finish time is not just the values in a 'fresh' state, but </span><strong style='background-color: rgba(0, 0, 0, 0);'>how well these values are preserved under fatigue</strong><span style='background-color: rgba(0, 0, 0, 0);'> (Resilience). Elite athletes may be making the difference because their physiological parameters remain 'intact' until the end of the race.</span></p>"
    },
    "references": [
      ...
      "oyner, M. J. (1991). Modeling: optimal marathon performance on the basis of physiological factors. Journal of Applied Physiology, 70(2), 683–687. https://doi.org/10.1152/jappl.1991.70.2.683"
    ]
  }
,
